...
<<plot2, fig.pos="h", fig.cap="Závislost mezi velikostí bot a velikosti zápěstí">>=
@
...
<<plot3, fig.pos="h", fig.cap="Závislost mezi pohlavím a velikosti zápěstí">>=
@
...
<<plot4, fig.pos="h", fig.cap="Závislost mezi velikostí bot a velikosti zápěstí pro pohlaví odděleně">>=
@
...
<<plot6, fig.pos="h", fig.cap="Závislost tepové frekvence a počtu hodin sportovních aktivit týdně">>=
@
